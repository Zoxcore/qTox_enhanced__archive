...
void Settings::saveGlobal()
{
    ...
    s.beginGroup("Video");
    {
        ...
        s.setValue("screenVideoFPS", screenVideoFPS);
...
void Settings::setScreenVideoFPS(int newValue)
{
    if (setVal(screenVideoFPS, newValue)) {
        emit screenVideoFPSChanged(newValue);
    }
}
